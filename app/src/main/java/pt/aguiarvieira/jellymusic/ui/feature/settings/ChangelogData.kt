...
val CHANGELOG: List<ChangelogVersion> = listOf(
    ...
    ChangelogVersion(
        ...
        changes = listOf(
            "Android Auto: search now works, with results grouped into artists, albums, songs " +
                "and playlists.",
            "Android Auto: the A\u2013Z button no longer shows an empty list.",
        ),
    ),
    ChangelogVersion(
        version = "0.1.85",
    ...
    ChangelogVersion(
        ...
        changes = listOf(
            "Shuffle and repeat are now yours alone: pressing Play on an album or playlist no " +
                ...
                "them \u2014 not switching album, playlist, library or queue, and not restarting the app.",
            "Repeat all is now the default instead of repeat off.",
        ),
    ),
    ChangelogVersion(
        version = "0.1.83",
    ...
    ChangelogVersion(
        ...
        changes = listOf(
            "The previous/next buttons on the full player now briefly light up in the accent " +
                ...
                "ripple circle on those two buttons is gone — it fought with the new highlight.",
    ...
    ChangelogVersion(
        ...
        changes = listOf(
            "The mini player at the bottom now floats just above the navigation/gesture bar with " +
                ...
                "corner and the play/pause button isn't right up against the screen edge.",
        ),
    ),
    ChangelogVersion(
        version = "0.1.79",
    ...
    ChangelogVersion(
        ...
        changes = listOf(
            "Downloads no longer follow the streaming transcode setting. Settings → Offline has a " +
                ...
                "originals (or high-bitrate copies) on the device while still streaming small.",
        ),
    ),
    ChangelogVersion(
        version = "0.1.76",
    ...
    ChangelogVersion(
        ...
        date = "29/07/2026",
        changes = listOf(
            "Music picked in Android Auto now sticks: disconnecting from the car and opening the app " +
                "keeps the album or playlist you chose while driving, instead of jumping back to " +
                "whatever was playing before.",
            "The resume position is now saved when playback stops, so picking up where you left off " +
                "is more accurate.",
        ),
    ),
    ChangelogVersion(
    ...
    ChangelogVersion(
        ...
        date = "24/07/2026",
        changes = listOf(
            "The home-screen widget's blurred background is now a smooth frosted wash instead of a " +
                "blocky one.",
            "The widget's shuffle and repeat buttons now light up in the album's accent colour when " +
                "on, instead of showing a circle behind them.",
        ),
    ),
    ChangelogVersion(
        version = "0.1.70",
